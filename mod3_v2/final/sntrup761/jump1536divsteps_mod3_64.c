...
int jump1536divsteps_mod3_64(int minusdelta, uint32_t *M, uint32_t *f, uint32_t *g);
...
extern void __update_VS_64x784(uint32_t *V, uint32_t *S, uint32_t *M1);
