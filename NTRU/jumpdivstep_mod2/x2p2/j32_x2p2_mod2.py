...
def polymul_16x16(h, g, tmp): # h = g * tmp
...
def main():
    ...
    polymul_16x16(h1, fh, h2)
    polymul_16x16(h2, gh, tmp)
    ...
    printIn("eor.w %s, %s, %s, LSL #%d" %(h2[1], h2[1], h1[1], bits_per_coeffi))
    printIn("eor.w %s, %s, %s, LSR #%d" %(h2[1], h2[1], h1[0], 32 - bits_per_coeffi))
