...
## 64
python gen_poly_r2_inv.py 64 508 512 > final/ntru509/poly_r2_inv_jumpdivsteps.c
...
python gen_poly_r2_inv.py 64 700 704 > final/ntru701/poly_r2_inv_jumpdivsteps.c
...
python gen_poly_r2_inv.py 64 820 832 > final/ntru821/poly_r2_inv_jumpdivsteps.c
