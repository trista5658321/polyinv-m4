...
from ntt_python.basemul import basemul_4x4
...
def get_base_w(p,w,n,final_deg):
    final = get_w(w,n,final_deg)[-1]
    base_w = []
    for c in final:
        left = c
        right = (w, n//2)
...
def ntt_16():
    ...
    #     # f0[i] = 1
    #     # g0[i] = 1
    #     f0[i] = randrange(0,7879) - (7879//2)
    #     g0[i] = randrange(0,7879) - (7879//2)
    ...
    # print(f0)
    ntt(n,layer,p,w,c,g0)
    # print(g0)
    basemul_4x4(p,h0,f0,g0,basemul_c)
    # print(h0)
...
flag = 1
for i in range(512):
    ans = crt(7879, h0[i], 1038337, h1[i], 7681)
    r_ans = reduce_center(7879, ans)
    if not ( r_ans == correct[i]):
        flag = 0
        print((i, r_ans))
