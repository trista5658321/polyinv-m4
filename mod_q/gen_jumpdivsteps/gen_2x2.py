...
def gen_2x2_onlyuv(n, basemul_base, v_spacing_16, v_spacing_32, r_spacing_16, r_spacing_32, s_spacing_16, s_spacing_32):
    print("void __gf_polymul_%dx%d_2x2_x_2x2_onlyuv(int * M, int * M1_16, int * M1_32, int * M2_16, int * M2_32){" % (n//2, n//2))
...
def gen_2x2_onlyvs(n, basemul_base, v_spacing_16, v_spacing_32, r_spacing_16, r_spacing_32, s_spacing_16, s_spacing_32):
    print("void __gf_polymul_%dx%d_2x2_x_2x2_onlyvs(int * M, int * M1_16, int * M1_32, int * M2_16, int * M2_32){" % (n//2, n//2))
    printIn("int tmp_16_1[%d];" % (n//2))
    printIn("int tmp_32_0[%d], tmp_32_1[%d];" % (n, n))
    printIn("int i, T, *X, *Y;")
    print("")
