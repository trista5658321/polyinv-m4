...
void gf_polymul_192x192(int *h, int *f, int *g){
    int16_t *ptr = (int16_t *)h;
...
void gf_polymul_64x64(int *h, int *f, int *g){
    int16_t *ptr = (int16_t *)h;
    for (int i = 0; i < 128; i++) *ptr++ = 0;
